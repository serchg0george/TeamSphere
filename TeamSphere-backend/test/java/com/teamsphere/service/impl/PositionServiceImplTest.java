...
public class PositionServiceImplTest {
    ...
    void find_shouldReturnPagedPositions_whenQueryMatchesName() {
        ...
        assertEquals(positionDto.getPositionName(), result.getContent().get(0).getPositionName());
    }
    ...
    void find_shouldReturnPagedPositions_whenQueryMatchesExperience() {
        ...
        assertEquals(1, result.getTotalElements());
        assertEquals(1, result.getContent().size());
        assertEquals(positionDto.getYearsOfExperience(), result.getContent().get(0).getYearsOfExperience());
    }
